                  ...
                  <div class="d-flex flex-column-fluid">
                     ...
                     <div class=" container ">
                        ...
                        <div class="text-center pt-15">
                           <h1 class="h2 font-weight-bolder text-white mb-6">
                             {{__("contact.Looking for Help?")}}
                           </h1>
                           <div class="h4 text-white-50 font-weight-normal">
                              {{__("contact.Submit your help request to one of our Metronic Experts!")}}
                        ...
                        <div class="card card-custom gutter-b">
                           ...
                           <div class="card-header">
                              <div class="card-title">
                                 <h5 class="card-label">
                                       {{__("contact.Send us your enquiries")}}
                           ...
                           <form class="form" method="post" action="{{ url('contact-us') }}">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control form-control-solid form-control-lg"  placeholder="{{__("contact.Enter your name")}}" required="required" name="full_name" value="{{ old('full_name') }}" />
                                       </div>
                                       <!--end::Input-->
                                       <!--begin::Input-->
                                       ...
                                       <div class="form-group">
                                          ...
                                          <input type="email" value="{{ old('email') }}" name="email" required="required" class="form-control form-control-solid form-control-lg"  placeholder="{{__("contact.Enter email")}}"/>
                                            <span style="color: red;">{{ $errors->first('email') }}</span>
                                       </div>
                                       <!--end::Input-->
                                        <div class="form-group">
                                          <label>{{__("contact.Phone")}}</label>
                                          <input type="text" value="{{ old('phone') }}" name="phone" class="form-control form-control-solid form-control-lg"  placeholder="{{__("contact.Enter your phone")}}"/>
                                       </div>

                                        <div class="form-group">
                                          <label>{{__("contact.Subject")}}</label>
                                          <input type="text" value="{{ old('subject') }}" required="required" name="subject" class="form-control form-control-solid form-control-lg"  placeholder="{{__("contact.Enter your subject")}}"/>
                                       </div>

                                       <!--begin::Input-->
                                       <div class="form-group">
                                          <label for="exampleTextarea">{{__("contact.Your Message")}}</label>
                                          <textarea class="form-control form-control-solid form-control-lg" id="exampleTextarea" rows="3" required="required" name="message">{{ old('message') }}</textarea>
                                       </div>
                                    ...
                                    <input type="hidden" name="current_captcha" value="{{ $firstNumber_acc + $secondNumber_acc}}"/>
                                          ...
                                          <input type="text" required="required" name="CaptchaCode" class="form-control form-control-solid form-control-lg"  placeholder="{{__("contact.Verification Code")}}"/>
                              ...
                              <div class="card-footer">
                                 <div class="row">
                                    <div class="col-xl-3"></div>
                                    <div class="col-xl-6">
                                       <button type="submit" class="btn btn-primary font-weight-bold mr-2">{{__("contact.Submit")}}</button>
                                       <button type="reset" class="btn btn-clean font-weight-bold">{{__("contact.Cancel")}}</button>
                                    </div>
                                    <div class="col-xl-3"></div>
                                 </div>
                              </div>
                                 ...
                                 <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between p-4">
                                       ...
                                       <div class="d-flex flex-column mr-5">
                                          ...
                                          {{__("contact.Or Reach Us by Live Chat")}}
                                          </a>
                                          <p class="text-dark-50">
                                               {{__("contact.Windows 10 automatically installs updates")}}
                                             <br/>
                                               {{__("contact.to make for sure")}}
                                          </p>
                                       </div>
                                       <!--end::Content-->
                                       <!--begin::Button-->
                                       <div class="ml-6 flex-shrink-0">
                                          <a href="#" data-toggle="modal" data-target="#kt_chat_modal" class="btn font-weight-bolder text-uppercase font-size-lg btn-primary py-3 px-6">  {{__("contact.Contact Us")}}</a>
                                       </div>
                                       <!--end::Button-->
                                    </div>
                                 </div>
