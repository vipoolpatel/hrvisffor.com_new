                     ...
                     <div class="login-form login-signin py-11">
                        ...
                        <form class="form" method="post" action="">
                           ...
                           <div class="text-center pb-8">
                              <h2 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">{{__("auth.Forgot Password")}}</h2>
                           ...
                           <div class="form-group">
                              <label class="font-size-h6 font-weight-bolder text-dark">{{__("auth.Username")}}</label>
                           ...
                           <div class="text-center pt-2">
                              <button id="kt_login_signin_submit" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">{{__("auth.Forgot")}}</button>
                           </div>
                           <!--end::Action-->
                        </form>
                        <!--end::Form-->
