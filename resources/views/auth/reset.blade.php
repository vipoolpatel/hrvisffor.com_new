                     ...
                     <div class="login-form login-signin py-11">
                        ...
                        <form class="form" method="post" action="">
                           ...
                           <div class="text-center pb-8">
                              <h2 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">{{__("auth.Reset Password")}} </h2>
                           ...
                           <div class="text-center pt-2">
                              <button id="kt_login_signin_submit" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">{{__("auth.Reset")}}</button>
                           </div>
                           <!--end::Action-->
                        </form>
                        <!--end::Form-->
            ...
            <div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #B1DCED;">
               ...
               <div class="d-flex flex-column justify-content-center text-center pt-lg-40 pt-md-5 pt-sm-5 px-lg-0 pt-5 px-7">
                  ...
                  <p class="font-weight-bolder font-size-h2-md font-size-lg text-dark opacity-70">
                     {{__("auth. VISFFOR, a UK-based company with other main offices in the United States, Canada,")}}
