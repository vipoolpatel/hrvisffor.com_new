               ...
               <div class="card card-custom">
                  ...
                  <div class="card-body">
                    ...
                    <div class="input-group input-group-solid">
                       ...
                       <input type="text" class="form-control py-4 h-auto" data-val="{{ $sender_id }}" id="SearchMember" placeholder="{{ __('chat.Search Member') }}" />
                    </div>

                    <div class="mt-7 scroll scroll-pull sroll-sidebar-user">
                        <span id="getChatUserChat">
                            @include('backend.privatechat._user')
                        </span>
            ...
            <div class="flex-row-fluid ml-lg-8"  id="kt_chat_content">
               ...
               <div class="card card-custom" >
                      ...
                      <span id="getMessageChat">
                           @include('backend.privatechat._all_chat')
                      </span>
...
<script type="text/javascript">
        ...
        $('body').delegate('.ChatLoadMore','click',function() {
            ...
            $.ajax({
                url: "{{ url('get_private_chat_user?page=') }}"+page,
                type: "POST",
                data:{
                 "_token": "{{ csrf_token() }}",
                 sender_id:sender_id,               
...
// get message and submit message
        ...
        @if(!empty($user_id) && empty($history))
          ...
          $('.getDirectMessage{{ $user_id }}').click();
...
// end get message and submit message
