...
<div class="card-footer align-items-center">
   <form action="" method="post" id="SubmitReply">
           {{ csrf_field() }}
           <input type="hidden" id="get_main_connect_id_chat" name="main_connect_id" value="{{ $main_connect_id }}">
           <input type="hidden" name="school_id" value="{{ $school_id }}">
           <input type="hidden" name="teacher_id" value="{{ $teacher_id }}">
           <input type="hidden" name="school_staff_id" value="{{ $school_staff_id }}">
           <input type="hidden" name="teacher_staff_id" value="{{ $teacher_staff_id }}">
