  @if(!empty($record))
   <form class="form" action="{{ url('admin/livingcost/edit/'.$record->id) }}" method="post" enctype="multipart/form-data">
  @else
                              ...
                              <div class="col-xl-7">
                                 <div class="row">
                                    ...
                                    <div class="col-9">
                                       ...
                                       <a href="{{ url('admin/livingcost') }}" class="btn btn-clean font-weight-bold">{{ __('manage.Cancel') }}</a>
                                    </div>
                                 </div>
                              </div>
                           </div>
