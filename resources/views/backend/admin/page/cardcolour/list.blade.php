         ...
         <div class="card card-custom">
            ...
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
               <div class="card-title">
                  <h3 class="card-label">
                      {{ __('manage.Card Colour List') }}
                  </h3>
               </div>
               <div class="card-toolbar">
                  <!--begin::Button-->
                  <a href="{{ url('admin/cardcolour/add') }}" class="btn btn-primary font-weight-bolder">
   ...
   var KTAppsUsersListDatatable = function() {
      ...
      var _demo = function() {
            ...
            data: {
               ...
               source: {
                  read: {
                     url: '{{ url('admin/cardcolour/get_cardcolour_list') }}?_token={{ csrf_token() }}',
                  },
               },
