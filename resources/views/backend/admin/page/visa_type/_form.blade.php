...
@if(!empty($record))
    <form class="form" action="{{ url('admin/visa-type/'.$record->id) }}" method="post" enctype="multipart/form-data">
        @else
            <form class="form" action="{{ url('admin/visa-type') }}" method="post" enctype="multipart/form-data">
                @endif
                {{ csrf_field() }}
                                ...
                                <div class="col-xl-7">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <a href="{{ url('admin/visa-type') }}" class="btn btn-clean font-weight-bold">{{ __('manage.Cancel') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
