 ...
 @if(!empty($record))
 <form class="form" action="{{ url('admin/current-location/edit/'.$record->id) }}" method="post" enctype="multipart/form-data">
 @else
                              ...
                              <div class="col-xl-7">
                                 <div class="row">
                                    ...
                                    <div class="col-9">
                                       ...
                                       <a href="{{ url('admin/current-location') }}" class="btn btn-clean font-weight-bold">{{ __('manage.Cancel') }}</a>
                                    </div>
                                 </div>
                              </div>
                           </div>
