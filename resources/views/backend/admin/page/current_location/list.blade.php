         ...
         <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex flex-column">
               ...
               <h2 class="text-white font-weight-bold my-2 mr-5">
                    {{ __('manage.Current Location') }}                                       
               </h2>
               <!--end::Title-->
               <!--begin::Breadcrumb-->
               <div class="d-flex align-items-center font-weight-bold my-2">
                  <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">
                 {{ __('manage.Current Location') }} </a>
                  <!--end::Item-->
                  <!--begin::Item-->
         ...
         <div class="card card-custom">
            ...
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
               <div class="card-title">
                  <h3 class="card-label">  {{ __('manage.Current Location List') }}
                     
                  </h3>
               </div>
               <div class="card-toolbar">
                  <!--begin::Button-->
                  <a href="{{ url('admin/current-location/add') }}" class="btn btn-primary font-weight-bolder">
   ...
   var KTAppsUsersListDatatable = function() {
      ...
      var _demo = function() {
            ...
            data: {
               ...
               source: {
                  read: {
                     url: '{{ url('admin/current_location/get_current_location_list') }}?_token={{ csrf_token() }}',
                  },
               },
