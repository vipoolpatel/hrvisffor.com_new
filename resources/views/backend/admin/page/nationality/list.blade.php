      ...
      <div class=" container  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
         ...
         <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex flex-column">
               ...
               {{ __('manage.Nationality') }}                                    
               </h2>
               <!--end::Title-->
               <!--begin::Breadcrumb-->
               <div class="d-flex align-items-center font-weight-bold my-2">
                  <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">
                       {{ __('manage.Nationality') }}  </a>
                  <!--end::Item-->
                  <!--begin::Item-->
         ...
         <div class="card card-custom">
            ...
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
               <div class="card-title">
                  <h3 class="card-label">
                     {{ __('manage.Nationality List') }}  
                  </h3>
               </div>
               <div class="card-toolbar">
                  <!--begin::Button-->
                  <a href="{{ url('admin/nationality/add') }}" class="btn btn-primary font-weight-bolder">
   ...
   var KTAppsUsersListDatatable = function() {
      ...
      var _demo = function() {
            ...
            data: {
               ...
               source: {
                  read: {
                     url: '{{ url('admin/nationality/get_nationality_list') }}?_token={{ csrf_token() }}',
                  },
               },
            ...
            columns: [
               ...
               },          
               {
                ...
                {
                  field: 'is_native',
                  title: '{{ __('manage.Native') }}',
                  template: function(row) {
                     return row.is_native;
                  }
               },
                 {
                  field: 'action',
